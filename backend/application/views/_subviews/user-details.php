<div class="user-details">
    <div class="contact-details">
        ...
        <p class="edit-link">
            ...
            <a class="edit-contact-link"><?php echo lang('home_contact_edit'); ?></a>
        </p>
    </div>
    ...
    <div class="linked-accounts">
			...
			<?php foreach ($openid_links as $openid_link) : ?>
                <li class="<?php echo $openid_link->provider; ?>">
                    ...
                    <?php if ($num_of_linked_accounts > 1) : ?>
						...
						<span class="link-indicator">&raquo;</span>
						<?php echo form_button(array('name' => 'open_id_' . $openid_link->openid, 'type' => 'submit', 'content' => lang('connect_remove'))); ?>
			...
			<?php foreach ($twitter_links as $twitter_link) : ?>
                <li class="twitter">
                    ...
                    <?php if ($num_of_linked_accounts > 1) : ?>
						...
						<span class="link-indicator">&raquo;</span>
						<?php echo form_button(array('name' => 'twitter_id_' . $twitter_link->twitter_id, 'type' => 'submit', 'content' => lang('connect_remove'))); ?>
						<?php echo form_fieldset_close(); ?>
						<?php echo form_close(); ?>
                    <?php endif; ?>
                </li>
			...
			<?php foreach ($facebook_links as $facebook_link) : ?>
                <li class="facebook">
                    ...
                    <?php if ($num_of_linked_accounts > 1) : ?>
						...
						<span class="link-indicator">&raquo;</span>
						<?php echo form_button(array('name' => 'facebook_id_' . $facebook_link->facebook_id, 'type' => 'submit', 'content' => lang('connect_remove'))); ?>
						<?php echo form_fieldset_close(); ?>
						<?php echo form_close(); ?>
                    <?php endif; ?>
                </li>
        ...
        <p class="edit-link">
            <span class="link-indicator">&raquo;</span>
            <a class="add-account-link"><?php echo lang('home_add_linked_account_link'); ?></a>
        </p>
    </div>
</div>
