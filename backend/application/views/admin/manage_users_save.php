...
<div class="container">
  <div class="row">
    ...
    <div class="span10">
      ...
      <div class="control-group">
          <label class="control-label" for="users_subdomains"><?php echo lang('users_restricted_subdomains'); ?></label>
      ...
      <div class="control-group">
          <label class="control-label" for="users_subdomains"><?php echo lang('users_unrestricted_subdomains'); ?></label>
