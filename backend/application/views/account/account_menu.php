<ul class="nav nav-list">
  ...
  <?php if ($this->authorization->is_permitted( array('retrieve_users', 'retrieve_subdomains', 'retrieve_roles', 'retrieve_permissions') )) : ?>
    ...
    <?php if ($this->authorization->is_permitted('retrieve_subdomains')) : ?>
      <li class="<?php echo ($current == 'manage_subdomains') ? 'active' : ''; ?>"><?php echo anchor('admin/manage_subdomains', lang('website_manage_subdomains')); ?></li>
    <?php endif; ?>
