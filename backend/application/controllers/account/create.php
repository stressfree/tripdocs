...
class Create extends CI_Controller {
	...
	function index()
	{
		...
		$this->form_validation->set_rules(array(array('field' => 'connect_create_fullname', 'label' => 'lang:connect_create_fullname', 'rules' => 'trim|required|max_length[160]'), array('field' => 'connect_create_email', 'label' => 'lang:connect_create_email', 'rules' => 'trim|required|valid_email|max_length[160]|is_unique[a3m_account.email]')));
