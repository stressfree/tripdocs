...
|--------------------------------------------------------------------------
*/
$config['third_party_auth_providers'] = array('google', 'yahoo', 'openid');
...
$config['password_reset_secret'] 		= 't3g33qg8gdslkdfjdveeq8uqfqefeoh';
$config['password_reset_email'] 		= 'no-reply@triptech.net';
